...
export const StyledNav = styled.nav`
    ...
    ${({ hostParent }) => hostParent === 'home' && `
        height:100%; margin: 3% 8.5%;
        flex-flow: column nowrap;
        a:first-child { width: 25%; align-self: end; margin-left: 8.5%; }
        a:nth-child(2) { width: 25%;  align-self: start;}
        a:nth-child(3) { width: 8.5%;  align-self: end; }
    `}
